...
Wonder How we can make an application to randomly select element using HTML CSS JS and by customising font-awesome icons directle in css? If No, this will be the perfect repo for you.

###### **Here is the link of [Live Demo](https://smilegupta.github.io/ramdom-option-selector/)**
...
***Glad to see you here! Show some love by [starring](https://github.com/smilegupta/ramdom-option-selector/) this repo.***
